...
insert into CUSTOMER values (12,' Vandana', 'Ray', 'MU','5560379, 2021-3-17, 1000.75);
insert into CUSTOMER values (13,'Pramada',' Jauguste ','DA', 4560389,25-jul-67, 500.00);
insert into CUSTOMER values (14,'Basu',' Navindi',' BA', 6125401,30-feb-56, 860.00);
insert into CUSTOMER values (15,' Ravi',' Shridhar','NA',,15-feb-89, 500.50);
insert into CUSTOMER values (16,'Rukmini',' Aiyer',' GH', 5125274, 23-jul-87,1500.50);
desc CUSTOMER;
...
insert into CUSTOMER values (12,' Rahul', 'Shinde', 'ut',6383848, 1983-3-17, 840.75);

insert into CUSTOMER values (13,'Ajay','Bagh','jd', 263737,25-jul-67, 80.00);
